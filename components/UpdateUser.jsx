...
const UpdateUser = () => {
    ...
    if (!submit) {
        return (
            ...
            <form action="/" className='flex w-1/2 ml-12' onSubmit={handleSubmit}>
           <div className=' container mx-auto'>
               ...
               <button className='mt-5 rounded-full border  bg-yellow-500 px-7 py-2 text-base font-medium text-white hover:bg-yellow-400 gap-5'>Submit</button>
           </div>
       </form>
